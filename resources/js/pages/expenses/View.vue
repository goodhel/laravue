    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Detail Expenses</h3>
            </div>
            <div class="card-body">
                <template>
                    ...
                    <dt>Status</dt>
                    <dd>
                        <span class="badge bg-success" v-if="status == 1">Diterima</span>
                        <span class="badge bg-warning" v-else-if="status == 0">Diproses</span>
                        <span class="badge bg-default" v-else>Ditolak</span>
                    </dd>
                    <hr>
                    <!-- INFORMASI DETAIL EXPENSES -->
