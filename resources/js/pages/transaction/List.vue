    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <router-link :to="{ name: 'transactions.add' }" class="btn btn-primary btn-sm">Add New</router-link>
            ...
            <div class="card-body">
                ...
                <b-table striped hover bordered :items="transactions.data" :fields="fields" show-empty>
                    ...
                    <template v-slot:cell(actions)="row">
                        <router-link :to="{ name: 'transactions.view', params: {id: row.item.id} }" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></router-link>
                    </template>
                </b-table>

            </div>
            <div class="card-footer prefix">
                <div class="row">
                    <div class="col-md-6">
