            ...
            <div class="col-md-6" v-if="showForm">
                <div class="form-group" :class="{ 'has-error': errors.name_laundry_type }">
                    ...
                    <div class="input-group">
                        <input type="text" placeholder="Cuci Kering + Setrika" v-model="laundry_type" class="form-control rounded-0">
                        <span class="input-group-append">
                            <!-- <button type="button" class="btn btn-info btn-flat">Go!</button> -->
                            <a href="javascript:void(0)" class="btn btn-warning" id="basic-addon2" @click="addNewLaundryType">Save</a>
                        </span>
                    </div>
