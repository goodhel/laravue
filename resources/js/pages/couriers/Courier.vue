    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <router-link :to="{ name: 'couriers.add' }" class="btn btn-primary btn-sm">Tambah</router-link>
                ...
                <b-table striped hover bordered :items="couriers.data" :fields="fields" show-empty>
                  ...
                  <!-- KITA MENGGUNAKAN CUSTOM TEMPLATE KARENA AKAN MENAMPILKAN GAMBAR -->
                    ...
                    <template v-slot:cell(actions)="row">
                        <router-link :to="{ name: 'couriers.edit', params: {id: row.item.id} }" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></router-link>
                        <button class="btn btn-danger btn-sm" @click="deleteCourier(row.item.id)"><i class="fas fa-trash"></i></button>
                    </template>
                </b-table>
